    ...
    <Animated.View style={[styles.heroCard, cardStyle]}>
      ...
      <View style={styles.heroHeader}>
        ...
        <View style={[styles.heroStatus, { backgroundColor: statusConfig.bg }]}>
          <StatusIcon color={statusConfig.color} size={14} strokeWidth={1.5} />
      ...
      <View style={styles.heroFooter}>
        <View style={styles.heroProgress}>
          ...
          <Text style={styles.heroProgressText}>{event.registered} of {event.capacity} registered</Text>
        </View>
      </View>
    </Animated.View>
  );
...
const ActionButton = ({ icon: Icon, title, onPress, variant = 'primary', disabled = false }) => {
  ...
  return (
    <Pressable 
      style={[styles.actionButton, getButtonStyle(), disabled && styles.actionButtonDisabled]} 
      onPress={onPress}
      disabled={disabled}
    >
...
export default function EventDetails() {
  ...
  const event = {
    ...
    capacity: 40,
    registered: 34,
    description: 'Master the latest React Native features with hands-on coding sessions and real-world projects. Learn advanced patterns, performance optimization, and deployment strategies.',
    requirements: 'Basic React knowledge, laptop with development environment setup, and mobile device for testing.',
    agenda: [
      '2:00 PM - Introduction & Setup',
      '2:30 PM - Advanced Navigation',
      '3:30 PM - State Management',
      '4:30 PM - Break',
      '4:45 PM - Native Modules',
      '5:30 PM - Deployment & Testing',
      '6:00 PM - Q&A Session'
    ],
    speaker: {
      name: 'Prof. Ahmed Benali',
      title: 'Senior Software Engineer at Meta',
      bio: '10+ years in mobile development, React Native core contributor, published researcher in mobile architecture patterns.',
      contact: 'ahmed.benali@1337.ma'
    },
    volunteers: [
      { id: 1, name: 'Sara Amrani', login: 'samrani', status: 'confirmed', role: 'Technical Assistant' },
      { id: 2, name: 'Omar Tazi', login: 'otazi', status: 'confirmed', role: 'Setup Coordinator' },
      { id: 3, name: 'Nadia Kassimi', login: 'nkassimi', status: 'pending', role: 'General Support' },
    ]
  };
      ...
      <View style={styles.container}>
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.emptyState}>
            <AlertCircle color="#6b7280" size={48} strokeWidth={1.5} />
